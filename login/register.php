<?php
    ...
    if ($result->num_rows > 0)
    {
        ...
        header("location: /yukba/login/error.php");
    }
    else
    {
        ...
        if ($mysqli->query($sql))
        {
            ...
            {
                header("location: /yukba/login/admin.php");
            }
                ...
                $message =  '<html>
                            ...
                            <body>
                                <div class="form">
                                    ...
                                    <a href="http://localhost/yukba/login/verify.php?id='.$id.'&hash='.$hash.'"><button class="button button-block">Activate Account</button></a>
                                </div>
                            </body>
                            </html>';
                mail($to, $subject, $message, $headers);
                header("location: /yukba/login/success.php");
            }
        }
        else
        {
