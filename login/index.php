<?php 
    ...
    {
        header("location: /yukba/new-1.php");
    ...
    elseif (isset($_POST['register']) && $_POST['firstname'] != "" && $_POST['remail'] != "" && $_POST['rpassword'] != "")
    {
            ...
            <div id="signup">   
                ...
                <form id="registerform" name="registerform" onsubmit="return signup_validation();" method="post" autocomplete="off">
                    <div class="top-row">
                        <div class="field-wrap">
                            <label>
                                Boutique Name<span class="req">*</span>
                            </label>
                            <input type="text" autocomplete="off" name='firstname' id='firstname' />
                        </div>  
                        <div class="field-wrap">
                            <!-- <label>
                                Boutique Last Name<span class="req">*</span>
                            </label> -->
