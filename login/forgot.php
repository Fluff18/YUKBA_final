<?php 
    ...
    {   
        ...
        else
        {
            ...
            ini_set('sendmail_from', "vishal23dps@gmail.com");
            ...
            $message =  '<html>
                        ...
                        <body>
                            <div class="form">
                                ...
                                <a href="http://localhost/yukba/login/reset.php?email='.$email.'&hash='.$hash.'"><button class="button button-block">Reset Password</button></a>
                            </div>
                        </body>
                        </html>';
